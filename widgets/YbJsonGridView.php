...
Yii::import('yiibooster.widgets.YbJsonDataColumn');

class YbJsonGridView extends TbGridView
{
	/**
	 * @var boolean $json true when there is an AJAX request. YbJsonGridView expect a JSON response.
	 */
	public $json;
	 ...
	 * Defaults to <code>array('class'=>'ext.yiibooster.widgets.YbPager')</code>.
	 */
	public $pager = array('class' => 'yiibooster.widgets.YbJsonPager');
	...
	protected function initColumns()
	{
		foreach ($this->columns as $i => $column)
		{
			if (is_array($column) && !isset($column['class']))
				$this->columns[$i]['class'] = 'yiibooster.widgets.YbJsonDataColumn';
		}
	 ...
	 * @return \YbJsonDataColumn|\TbDataColumn|\CDataColumn the column instance
	...
	protected function createDataColumn($text)
	{
		...
		$column = new YbJsonDataColumn($this);
