<?php
/**
 * YbExtendedGridView class file
 *
 *
 * @author: antonio ramirez <antonio@clevertech.biz>
 * @copyright Copyright &copy; Clevertech 2012-
 * @license http://www.opensource.org/licenses/bsd-license.php New BSD License
 * @package YiiBooster yiibooster.widgets
 */
Yii::import('bootstrap.widgets.TbGridView');

/**
 * YbExtendedGridView is an extended version of TbGridView.
 *
 * Features are:
 *  - Display an extended summary of the records shown. The extended summary can be configured to any of the
 *  {@link YbOperation} type of widgets.
 *  - Automatic chart display (using YbHighCharts widget), where user can 'switch' between views.
 *  - Selectable cells
 *  - Sortable rows
 */
class YbExtendedGridView extends TbGridView
{
	/**
	 ...
	 * please, see {@link YbSumOperation}, {@link YbSumOfTypeOperation},{@link YbPercentOfTypeGooglePieOperation}
	 * {@link YbPercentOfTypeOperation} and {@link YbPercentOfTypeEasyPieOperation}.
	 *
	 * The following is an example, please review the different types of YbOperation classes to find out more about
	 ...
	 *              'class' => 'YbSumOperation', // what is the type of YbOperation we are going to display
	 *              'label' => 'Sum of Ids'     // label is name of label of the resulted value (ie Sum of Ids:)
	 *          ),
	 *          'results' => array(   // column name "results"
	 *              'class' => 'YbPercentOfTypeGooglePieOperation', // the type of YbOperation
	 *              'label' => 'How Many Of Each? ', // the label of the operation
	 *              'types' => array(               // YbPercentOfTypeGooglePieOperation "types" attributes
	 ...
	 * @see bootstrap.action.YbSortableAction for an easy way to use with your controller
	 */
	...
	/**
	 * @var array the configuration options to display a YbBulkActions widget
	 * @see YbBulkActions widget for its configuration
	 */
	...
	/**
	 * @var YbBulkActions component that will display the bulk actions to the grid
	 */
	protected $bulk;
	...
	/**
	 * @var array $extendedSummaryTypes hold the current configured YbOperation that will process column values.
	 */
	...
	protected $extendedSummaryOperations = array(
		'YbSumOperation',
		'YbCountOfTypeOperation',
		'YbPercentOfTypeOperation',
		'YbPercentOfTypeEasyPieOperation',
		'YbPercentOfTypeGooglePieOperation'
	);
	...
	public function init()
	{
		...
		if ($this->bulkActions !== array() && isset($this->bulkActions['actionButtons']))
		{
			if(!isset($this->bulkActions['class']))
				$this->bulkActions['class'] = 'yiibooster.widgets.YbBulkActions';
	...
	public function renderChart()
	{
		...
		$configChart = array(
			'class' => 'yiibooster.widgets.YbHighCharts',
			'id' => $chartId,
			'options' => $options,
 ...
 */
abstract class YbOperation extends CWidget
{
	/**
...
/**
 * YbSumOperation class
 *
 * Displays a total of specified column name.
 *
 */
class YbSumOperation extends YbOperation
{
	/**
 ...
 */
class YbCountOfTypeOperation extends YbOperation
{
	/**
	 * @var string $template
	 * @see parent class
...
/**
 * YbPercentOfTypeOperation class
 ...
 */
class YbPercentOfTypeOperation extends YbCountOfTypeOperation
{
	/**
	 * @var string $typeTemplate
	 * @see YbCountOfTypeOperation
	 */
	public $typeTemplate = '{label}({value}%)';
...
/**
 * YbPercentOfTypeGooglePieOperation class
 *
 * Displays a Google visualization  pie chart based on the percentage count of type.
 */
class YbPercentOfTypeGooglePieOperation extends YbPercentOfTypeOperation
{
	/**
	...
	{
		$chart = Yii::createComponent(array('class' => 'yiibooster.widgets.YbGoogleVisualizationChart',
		 ...
		 * @see YbGoogleVisualizationChart
		 */
...
/**
 * YbPercentOfTypeEasyPieOperation class
 *
 * Displays an chart based on jquery.easy.pie plugin
 */
class YbPercentOfTypeEasyPieOperation extends YbPercentOfTypeOperation
{
	/**
