...
class YbFileUpload extends CJuiInputWidget
{
	/**
	 ...
	 */
	public $formView = 'yiibooster.views.fileupload.form';

	/**
	 * @var string name of the upload view to be rendered
	 */
	public $uploadView = 'yiibooster.views.fileupload.upload';

	/**
	 * @var string name of the download view to be rendered
	 */
	public $downloadView = 'yiibooster.views.fileupload.download';

	/**
	 * @var string name of the view to display images at bootstrap-slideshow
	 */
	public $previewImagesView = 'yiibooster.views.gallery.preview';
