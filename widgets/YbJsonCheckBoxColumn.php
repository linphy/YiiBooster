<?php
/**
 * YbJsonCheckBoxColumn class
 * Works in conjunction with YbJsonGridView. Renders HTML or returns JSON containing checkbox
 ...
 */
class YbJsonCheckBoxColumn extends CCheckBoxColumn
{
    /**
