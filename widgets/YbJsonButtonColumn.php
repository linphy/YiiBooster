<?php
/**
 * YbJsonButtonColumn class
 * Works in conjunction with YbJsonGridView. Renders HTML or returns JSON according to the request to the Grid.
 *
 ...
 */
Yii::import('yiibooster.widgets.YbButtonColumn');

class YbJsonButtonColumn extends TbButtonColumn
{
	/**
