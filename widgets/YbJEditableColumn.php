...
class YbJEditableColumn extends TbDataColumn
{
	/**
	...
	public function registerClientScript()
	{
		...
		$cs->registerCss('YbJEditableColumnTimepickerCSS#' . $this->id, "
		...
		$cs->registerScript('YbJEditableColumn#' . $this->id, "
