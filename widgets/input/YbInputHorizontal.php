...
class YbInputHorizontal extends YbInput
{
	/**
	 * Runs the widget.
	 */
	...
	protected function toggleButton()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('yiibooster.widgets.YbToggleButton', $options);
		echo $this->getError() . $this->getHint();
		echo '</div>';
	}
	...
	protected function datepickerField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('yiibooster.widgets.YbDatePicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
	...
	protected function colorpickerField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('yiibooster.widgets.YbColorPicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'format' => $format,
			'events' => isset($events) ? $events : array(),
	...
	protected function redactorJs()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('yiibooster.widgets.YbRedactorJs', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
	...
	protected function markdownEditorJs()
	{
		...
		$this->widget('yiibooster.widgets.YbMarkdownEditorJs', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'width' => isset($width) ? $width : '100%',
			'height' => isset($height) ? $height : '400px',
	...
	/**
	 * Renders yiibooster wysihtml5 editor.
	 * @return mixed|void
	 */
	protected function html5Editor()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('yiibooster.widgets.YbHtml5Editor', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'editorOptions' => isset($options) ? $options : array(),
			'width' => isset($width) ? $width : '100%',
	...
	protected function ckEditor()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('yiibooster.widgets.YbCKEditor', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'editorOptions' => isset($options) ? $options : array(),
			'htmlOptions' => $this->htmlOptions
	...
	protected function dateRangeField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('yiibooster.widgets.YbDateRangePicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'options' => isset($options) ? $options : array(),
	...
	protected function timepickerField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('yiibooster.widgets.YbTimePicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'options' => isset($options) ? $options : array(),
			'events' => isset($events) ? $events : array(),
	...
	protected function select2Field()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('yiibooster.widgets.YbSelect2', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'options' => isset($options) ? $options : array(),
			'events' => isset($events) ? $events : array(),
